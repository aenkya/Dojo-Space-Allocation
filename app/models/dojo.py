...
class Dojo(object):
    ...
    def print_unallocated_people(self):
        file_name = input("Enter file to save to: ")
        print('\n'.join(x.name for x in self.unallocated_people))
        self.print_to_file(
    ...
    def save_people(self):
        ...
        for person in self.staff:
            person_name = self.staff[person].name
            gender = self.staff[person].gender
            nationality = self.staff[person].nationality

            person_to_save = Staff(
    ...
    def save_rooms(self):
        for room in self.living_spaces:
            ...
            print(self.living_spaces[room].room_mates)
        ...
        for room in self.office_spaces:
            ...
            print(self.office_spaces[room].room_mates)
            self.database.session.add(room_to_save)
